...
function (_Component) {
  ...
  _createClass(NavbarSection, [{
    ...
    value: function render() {
      ...
      var currentIndex = this.state.activeIndices[this.state.activeIndices.length - 1]; // copy props from parent to the children
